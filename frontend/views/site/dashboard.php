...
<div class="site-dashboard">
    <div class="container">
        <div class="my-courses d-flex justify-content-between align-items-baseline">
            <h4>Kurslarim</h4>
            ...
            <div class="row row-cols-1 row-cols-lg-3 row-cols-md-2 g-4">
                <div class="col">
                    <div class="card h-100" data-aos="fade-up-right">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Web Dasturlashga kirish</h5>
                ...
                <div class="col">
                    <div class="card h-100" data-aos="fade-up-right">
                        <img src="https://picsum.photos/300/200?random=6" class="card-img-top" alt="Kurs rasmi">
                        <div class="card-body">
                            <h5 class="card-title">Ma'lumotlar Bazasi Murakkablashtirilgan</h5>
                            <div class="content-main">
                                <span class="btn btn-outline-primary">
                                    <i class="bi bi-camera-video"></i>
                                    10 / 30
                            ...
                            <div class="progress">
                                <div class="progress-bar bg-primary" data-percent="89"></div>
                            </div>
                            <a href="#" class="continue-link w-100 mt-3 d-flex flex-row justify-content-end">Darsni davom ettirish</a>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card h-100" data-aos="fade-up-right">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">C++ Dasturlash</h5>
                            <div class="progress">
                                <div class="progress-bar bg-primary" data-percent="49"></div>
                            </div>
                            <a href="#" class="continue-link w-100 mt-3 d-flex flex-row justify-content-end">Darsni davom ettirish</a>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card h-100" data-aos="fade-up-right">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Ma'lumotlar Bazasi</h5>
                            <div class="progress">
                                <div class="progress-bar bg-primary"  data-percent="15"></div>
                            </div>
                            <a href="#" class="continue-link w-100 mt-3 d-flex flex-row justify-content-end">Darsni davom ettirish</a>
                        </div>
                    </div>
